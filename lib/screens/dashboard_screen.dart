...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _ComingSoon(role: 'User', user: user);
  }
}
...
class _ComingSoon extends StatelessWidget {
  final String role;
  final OVUser? user;
  const _ComingSoon({required this.role, this.user});
      ...
      body: SafeArea(child: Column(children: [
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Row(children: [
                Container(padding: const EdgeInsets.all(6),
                    decoration: BoxDecoration(color: OV.primary.withOpacity(0.12),
                  ...
                  child: Container(padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                      ...
                      child: Row(children: [
                        ...
                        Text('Sign Out', style: GoogleFonts.inter(
                            fontSize: 12, fontWeight: FontWeight.w500, color: OV.onSurfaceVariant)),
                      ]))),
            ])),
        Expanded(child: Center(child: Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Text('The $role module is coming soon.',
