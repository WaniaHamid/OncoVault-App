                  ...
                  child: Row(
                      ...
                      children: [
                        ...
                        Row(children: [
                          ...
                          StreamBuilder<List>(
                              stream: service
                                  .watchDoctorNotifications(doctorId)
                              ...
                              builder: (_, snap) {
                                ...
                                return GestureDetector(
                                    onTap: () => Navigator.push(
                                        context,
                                        dSlide(DoctorNotificationsScreen(
                                            doctorId: doctorId))),
              ...
              child: StreamBuilder<List<AppointmentModel>>(
                  ...
                  builder: (_, snap) {
                          ...
                          child: Center(
                              child: SizedBox(
                                  ...
                                  child: CircularProgressIndicator(
                                      strokeWidth: 2, color: OV.primary))));
                    }
                          ...
                          child: Container(
                              ...
                              child: Row(children: [
                                Icon(Icons.event_available_rounded,
                                    color: OV.outlineVariant, size: 28),
                    ...
                    return Padding(
                        ...
                        child: Column(
                            children: todayAppts
                                .map((a) => _AppointmentScheduleItem(appt: a))
                                .toList()));
                  })),
                  ...
                  child: GestureDetector(
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(16),
                              border:
                              Border.all(color: OV.primary.withOpacity(0.25))),
                          child: Row(children: [
                            Container(
                                width: 44,
                                height: 44,
          ...
          child: Row(children: [
            ...
            Column(children: [
              Container(
                  ...
                  height: 10,
                  decoration:
                  BoxDecoration(color: _lineColor, shape: BoxShape.circle)),
              Expanded(
                  child: Container(width: 2, color: _lineColor.withOpacity(0.2))),
            ]),
            const SizedBox(width: 12),
            Expanded(
                child: Container(
...
class _BottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
      decoration: BoxDecoration(
          color: Colors.white,
          border: Border(
              top: BorderSide(color: OV.outlineVariant.withOpacity(0.5)))),
      child: SafeArea(
          child: Padding(
